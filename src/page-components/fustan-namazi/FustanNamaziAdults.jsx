...
const CONTENT = {
  sq: {
    heading: "Fustane Namazi për të Rritur",
    intro: "Zbulo koleksionin tonë të fustaneve për namaz – të butë, të rehatshëm dhe të dizajnuar për rehati maksimale gjatë faljes.",
    priceLabel: "Çmimi:",
    colorsLabel: "Ngjyra të disponueshme:",
    colorsValue: "20 variante",
    sectionTitle: "Modelet më të preferuara",
    products: [
      {
        id: 1,
  ...
  en: {
    heading: "Prayer Dresses for Adults",
    intro: "Discover our collection of prayer dresses — soft, comfortable, and designed for maximum ease during prayer.",
    priceLabel: "Price:",
    colorsLabel: "Available colors:",
    colorsValue: "20 variants",
    sectionTitle: "Most Loved Designs",
    products: [
      {
        id: 1,
        image: "/fustane-namazi/te_rritur/1.jpeg",
        name: "Prayer Dress - Royal Blue",
        price: "2200L",
        color: "A deep, calming color for full focus during prayer"
      },
      {
        id: 2,
        image: "/fustane-namazi/te_rritur/2.jpg",
        name: "Prayer Dress - Classic Black",
        price: "2200L",
        color: "Elegance and simplicity — the most preferred choice for every day"
      },
      {
        id: 3,
        image: "/fustane-namazi/te_rritur/3.jpeg",
        name: "Prayer Dress - Soft Pink",
        price: "2200L",
        color: "A delicate, feminine shade that brings calm and comfort"
      },
      {
        id: 4,
        image: "/fustane-namazi/te_rritur/4.jpg",
        name: "Prayer Dress - Natural Beige",
        price: "2200L",
        color: "Neutral and easy to pair — perfect for every season"
      }
    ],
  },
};

const FustanNamaziAdults = (props) => {
        ...
        <div className="w-full h-full md:px-32 px-6">
          <div className="md:mt-8 mt-2 rounded-lg flex flex-col lg:flex-row items-center lg:items-start bg-white">
            ...
            <div className="mt-4 flex flex-col pb-4">
              ...
              <div className="text-gray-700">
                <strong>{t.colorsLabel}</strong>{" "}
                <span className="text-gray-600">{t.colorsValue}</span>
              </div>
            </div>
