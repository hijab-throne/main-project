...
const CONTENT = {
  sq: {
    ...
    mainAlt: "Kapuc",
    featuresTitle: "Karakteristikat e Kapucit Classic Ecardin",
    features: [
      {
...
export default function KapucEcardinClassic(props) {
