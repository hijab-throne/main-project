...
const CONTENT = {
  sq: {
    ...
    mainAlt: "Kapuc",
    featuresTitle: "Karakteristikat e Kapucit elastik xhufke",
    features: [
      {
...
export default function KapucXhElastik(props) {
