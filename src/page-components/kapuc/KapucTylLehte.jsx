...
const CONTENT = {
  sq: {
    ...
    mainAlt: "Kapuc",
    featuresTitle: "Karakteristikat e Kapucit Tyl i lehte",
    features: [
      {
...
export default function KapucTylLehte(props) {
