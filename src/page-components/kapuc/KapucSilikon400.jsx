...
const CONTENT = {
  sq: {
    ...
    mainAlt: "Kapuc",
    featuresTitle: "Karakteristikat me silikon (kaymaz)",
    features: [
      {
  ...
  en: {
    ...
    details: [
      "<strong>Price</strong> 400L"
    ],
  },
};

export default function KapucSilikon400(props) {
