...
const CONTENT = {
  sq: {
    ...
    mainAlt: "Kapuc",
    featuresTitle: "Karakteristikat e Kapucit Ceneli",
    features: [
      {
...
export default function KapucCeneli(props) {
