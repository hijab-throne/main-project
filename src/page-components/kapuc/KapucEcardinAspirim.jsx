...
const CONTENT = {
  sq: {
    ...
    mainAlt: "Kapuc",
    featuresTitle: "Karakteristikat e Kapucit Climatic Ecardin",
    features: [
      {
...
export default function KapucEcardinAspirim(props) {
