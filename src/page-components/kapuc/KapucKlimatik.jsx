...
const CONTENT = {
  sq: {
    title: "Kapuc me aspirim (Klimatik)",
    ...
    mainAlt: "Kapuc",
    featuresTitle: "Karakteristikat e Kapucit me aspirim (Klimatik)",
    features: [
      {
...
export default function KapucKlimatik(props) {
