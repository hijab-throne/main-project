...
export default function NotFound({ locale = 'sq' }) {
  const [mounted, setMounted] = useState(false);
  const message = locale === 'en' ? 'The page you are looking for does not exist.' : 'Faqja që po kërkoni nuk ekziston.';
  const linkText = locale === 'en' ? 'Back to homepage' : 'Kthehu në faqen kryesore';
    ...
    <>
      ...
      <div className="nf-wrapper">
        ...
        <div className={`nf-content ${mounted ? "visible" : ""}`}>
          ...
          <a href={homeHref} className="nf-link">
