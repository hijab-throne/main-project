...
const CONTENT = {
  sq: {
    title: "Shami Praktike per femije",
  ...
  en: {
    title: "Practical Hijab for Kids",
    ...
    features: [
      ...
      },
      {
        ...
        description: "Designed for active wearers, it can be put on without a mirror and stays in place without unwanted slipping."
      },
      {
        title: "Non-Slip",
      ...
      },
      {
        ...
        description: "Neutral colors and a clean design make it perfect for school or daily outings."
      }
    ],
    details: [
...
export default function PraktikeFemije(props) {
